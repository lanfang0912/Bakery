...
const INITIAL_EVENTS = [
  ...
  {id:26, date:'2026-06-15', start:'15:00', end:'17:00', teacher:'陳聖天老師',       title:'獨家快閃班：北京宮廷驢打滾',         link:'https://forms.gle/GwJFxxhytVG1KKTW6', color:'purple', fee:1800},
  ...
  {id:27, date:'2026-06-02', start:'13:30', end:'16:30', teacher:'雙張老師合體',     title:'蜂巢杜拜巧克力波士頓派',             link:'https://forms.gle/RFxLjNTc7jwnL32s5', color:'red',    fee:1900},
];
...
const FB_CONFIG = {
  ...
  storageBucket: 'whitedessert.appspot.com',
...
function formatFee(fee) {
  ...
  return 'NT$' + n.toLocaleString('zh-TW') + ' 元';
}
